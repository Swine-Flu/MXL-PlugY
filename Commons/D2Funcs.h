...
F7(STD,	 D2Common,00000,00000,00000,00000,00000,00000,11120,00000,	int,			D2GetPlayerSkillCount, (int nClassId));
...
A7(FAST, D2Client,00000,00000,00000,00000,00000,00000,46150,00000,	Unit*,		D2GetActiveNpc, ());
A7(FAST, D2Client,00000,00000,00000,00000,00000,00000,460A0,00000,	void,		D2ClearShopMenu, (Unit* ptVendor));
...
A7(FAST, D2Game,00000,00000,00000,00000,00000,00000,9F9A0,00000,	void,		D2SetSkillLevel, (Unit* ptChar, int nSkillId, int nSkillLvl, BOOL bRemove));
A7(FAST, D2Game,00000,00000,00000,00000,00000,00000,8D5F0,00000,	void,		D2UpdateSkillLevel, (NetClient* ptClient, Unit* ptChar, int nSkillId, int nSkillLvl, BOOL bRemove));
A7(FAST, D2Game,00000,00000,00000,00000,00000,00000,BF810,00000,	void,		D2InitVendorStock, (Game* ptGame, Unit* ptPlayer, Unit* ptVendor, BOOL bInit, BOOL bGamble));
A7(FAST, D2Game,00000,00000,00000,00000,00000,00000,8F620,00000,	void,		D2FreeVendorStock, (Game* ptGame, Unit* ptPlayer, Unit* ptVendor));
...
C7(D2Client, 000000,000000,000000,000000,000000,000000,11C304,000000,	void*,		StatsFrameGfx);
C7(D2Client, 000000,000000,000000,000000,000000,000000,11C300,000000,	void*,		StatsButtonGfx);

C7(D2Client, 000000,000000,000000,000000,000000,000000,1197A8,000000,	BOOL,		ActiveGambleMenu);
C7(D2Client, 000000,000000,000000,000000,000000,000000,11BC34,000000,	DWORD,		PlayerInteraction);
C7(D2Client, 000000,000000,000000,000000,000000,000000,119663,000000,	DWORD,		VendorInteraction);
C7(D2Client, 000000,000000,000000,000000,000000,000000,122309,000000,	DWORD,		TransactionTimeStamp);

C7(D2Client, 000000,000000,000000,000000,000000,000000,11C394,000000,	DWORD,		GameMode);

C7(D2Game,   000000,000000,000000,000000,000000,000000,0CB0DE,000000,	DWORD,		SaveFileSizeLimit);
