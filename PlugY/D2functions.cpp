...
TD2SetSkillLevel			V2SetSkillLevel;
TD2UpdateSkillLevel			V2UpdateSkillLevel;

TD2InitVendorStock			V2InitVendorStock;
TD2FreeVendorStock			V2FreeVendorStock;

TD2ClearShopMenu			V2ClearShopMenu;
...
FCT_ASM( D2SetSkillLevel_113 )
	PUSH ESI
	MOV ESI, ECX
	MOV EAX, EDX
	PUSH DWORD PTR SS:[ESP+0x0C]
	PUSH DWORD PTR SS:[ESP+0x0C]
	CALL V2SetSkillLevel
	POP ESI
	RETN 0x08
}}

FCT_ASM( D2UpdateSkillLevel_113 )
	PUSH ESI
	PUSH EBX
	MOV EAX, ECX
	MOV ESI, EDX
	...
	PUSH DWORD PTR SS:[ESP+0x14]
	PUSH DWORD PTR SS:[ESP+0x14]
	CALL V2UpdateSkillLevel
	POP EBX
	POP ESI
	RETN 0x0C
}}

FCT_ASM( D2InitVendorStock_113 )
	PUSH DWORD PTR SS:[ESP+0x0C]
	PUSH DWORD PTR SS:[ESP+0x0C]
	MOV EAX, DWORD PTR SS:[ESP+0x0C]
	PUSH EDX
	PUSH ECX
	CALL V2InitVendorStock
	RETN 0x0C
}}

FCT_ASM( D2FreeVendorStock_113 )
	PUSH EBX
	MOV EBX, ECX
	MOV ECX, EDX
	MOV EAX, DWORD PTR SS:[ESP+0x08]
	CALL V2FreeVendorStock
	POP EBX
	RETN 0x04
}}

FCT_ASM( D2ClearShopMenu_113 )
	MOV EAX, ECX
	CALL V2ClearShopMenu
	RETN
}}
...
//#undef V3
	...
	V2SetSkillLevel = D2SetSkillLevel;
	V2UpdateSkillLevel = D2UpdateSkillLevel;

	V2InitVendorStock = D2InitVendorStock;
	V2FreeVendorStock = D2FreeVendorStock;

	V2ClearShopMenu = D2ClearShopMenu;
	...
	D2SetSkillLevel = (TD2SetSkillLevel) D2SetSkillLevel_113;
	D2UpdateSkillLevel = (TD2UpdateSkillLevel) D2UpdateSkillLevel_113;
	
	D2InitVendorStock = (TD2InitVendorStock) D2InitVendorStock_113;
	D2FreeVendorStock = (TD2FreeVendorStock) D2FreeVendorStock_113;

	D2ClearShopMenu = (TD2ClearShopMenu) D2ClearShopMenu_113;
