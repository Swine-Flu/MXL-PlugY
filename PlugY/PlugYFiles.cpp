...
void* gpClosePageButtonGfx = NULL;
void* gpStatsPageBackgroundGfx = NULL;
void* gpRefreshStockButtonGfx = NULL;
...
void STDCALL freeCustomImages()
{
	...
	D2FreeModImage(&gpClosePageButtonGfx);
	D2FreeModImage(&gpStatsPageBackgroundGfx);
	D2FreeModImage(&gpRefreshStockButtonGfx);
}
