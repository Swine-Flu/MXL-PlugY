...
FCT_ASM( caller_SaveSPPlayerCustomData_113 )
	CALL D2FogGetSavePath
	MOV ECX, DWORD PTR DS:[ptSaveFileSizeLimit]
	MOV ECX, DWORD PTR DS:[ECX]
	LEA EDX, DWORD PTR SS:[ESP+ECX+0x0608]
	PUSH DWORD PTR SS:[EDX]
...
FCT_ASM( caller_SendSaveFilesToSave_113 )
	MOV ECX, DWORD PTR DS:[ptSaveFileSizeLimit]
	MOV ECX, DWORD PTR DS:[ECX]
	LEA EDX, DWORD PTR SS:[ESP+ECX+0x14]
	PUSH DWORD PTR SS:[EDX]
	CALL SendSaveFilesToSave
...
void Install_SavePlayerData()
{
	...
	mem_seek R7(D2Game, 000000, 000000, 000000, 000000, 000000, 000000, 053F35, 000000);
	MEMJ_REF4(D2FogGetSavePath, caller_SaveSPPlayerCustomData_113);
	/*
	...
	*/
	...
	//Send SaveFiles
	mem_seek R7(D2Game, 000000, 000000, 000000, 000000, 000000, 000000, 053EAB, 000000);
	memt_byte(0x8B, 0x90);
	memt_byte(0x44, 0xE8);
	MEMT_REF4(0xC0850424, caller_SendSaveFilesToSave_113);
	/*
